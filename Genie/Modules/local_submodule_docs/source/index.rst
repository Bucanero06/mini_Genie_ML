...
================================================
    ...
    .. |Build Status| image:: https://travis-ci.com/hudson-and-thames/Modules.svg?branch=master
    ...
    .. |PyPi| image:: https://img.shields.io/pypi/v/Modules.svg
        :target: https://pypi.org/project/genieml_src/

    .. |Downloads| image:: https://img.shields.io/pypi/dm/Modules.svg
        :target: https://pypi.org/project/genieml_src/

    .. |Python| image:: https://img.shields.io/pypi/pyversions/Modules.svg
        :target: https://pypi.org/project/genieml_src/
...
We lower barriers to entry for all users by providing extensive `documentation <https://Modules.readthedocs.io/en/latest/>`_
...
* `Documentation <https://Modules.readthedocs.io/en/latest/>`_
