...
================================================
    ...
    .. |Build Status| image:: https://travis-ci.com/hudson-and-thames/genieml_src.svg?branch=master
        :target: https://travis-ci.com/hudson-and-thames/genieml_src

    .. |codecov| image:: https://codecov.io/gh/hudson-and-thames/genieml_src/branch/master/graph/badge.svg
        :target: https://codecov.io/gh/hudson-and-thames/genieml_src

    .. |pylint Score| image:: https://mperlet.github.io/pybadge/badges/10.svg

    |Downloads|

    .. |PyPi| image:: https://img.shields.io/pypi/v/genieml_src.svg
        :target: https://pypi.org/project/genieml_src/

    .. |Downloads| image:: https://img.shields.io/pypi/dm/genieml_src.svg
        :target: https://pypi.org/project/genieml_src/

    .. |Python| image:: https://img.shields.io/pypi/pyversions/genieml_src.svg
        :target: https://pypi.org/project/genieml_src/
...
We lower barriers to entry for all users by providing extensive `documentation <https://genieml_src.readthedocs.io/en/latest/>`_
...
* `Documentation <https://genieml_src.readthedocs.io/en/latest/>`_
...
`LICENSE.txt <https://github.com/hudson-and-thames/genieml_src/blob/master/LICENSE.txt>`_ file for details.
