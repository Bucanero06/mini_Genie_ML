...
.. py:currentmodule:: genieml_src.labeling.excess_over_mean

.. automodule:: genieml_src.labeling.excess_over_mean
   :members:
...
.. code-block::
    ...
    from genieml_src.labeling import excess_over_mean
