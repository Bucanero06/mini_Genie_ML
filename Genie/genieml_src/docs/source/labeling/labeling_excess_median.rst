...
.. py:currentmodule:: genieml_src.labeling.excess_over_median

.. automodule:: genieml_src.labeling.excess_over_median
   :members:
...
.. code-block::
    ...
    from genieml_src.labeling import excess_over_median
