...
.. py:currentmodule:: genieml_src.labeling.fixed_time_horizon
.. automodule:: genieml_src.labeling.fixed_time_horizon
   :members:
...
.. code-block::
    ...
    from genieml_src.labeling import fixed_time_horizon
