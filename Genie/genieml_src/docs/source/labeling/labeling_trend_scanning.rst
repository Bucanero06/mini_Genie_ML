...
.. py:currentmodule:: genieml_src.labeling.trend_scanning
.. automodule:: genieml_src.labeling.trend_scanning
   :members:
...
.. code-block::
    ...
    from genieml_src.labeling import trend_scanning_labels
