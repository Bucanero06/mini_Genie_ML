...
Implementation
##############
.. py:currentmodule:: genieml_src.labeling.labeling
...
open-source python package (genieml_src) that is based on the work of Dr. Marcos Lopez de Prado in his book
