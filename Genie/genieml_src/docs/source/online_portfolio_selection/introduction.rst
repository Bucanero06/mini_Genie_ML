...
.. code-block::
    ...
    from genieml_src.online_portfolio_selection import *

    # Import all benchmark strategies.
    from genieml_src.online_portfolio_selection.benchmarks import *

    # Import all momentum strategies.
    from genieml_src.online_portfolio_selection.momentum import *

    # Import all mean reversion strategies.
    from genieml_src.online_portfolio_selection.mean_reversion import *

    # Import all pattern matching strategies.
    from genieml_src.online_portfolio_selection.pattern_matching import *

    # Import a specific buy and hold strategy.
    from genieml_src.online_portfolio_selection import BAH

    # Import buy and hold and universal portfolio.
    from genieml_src.online_portfolio_selection import BAH, UP
...
.. automodule:: genieml_src.online_portfolio_selection.base
