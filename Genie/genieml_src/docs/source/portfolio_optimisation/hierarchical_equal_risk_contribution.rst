...
.. automodule:: genieml_src.portfolio_optimization.herc
...
.. tip::
    ...
    The following linkage methods are supported by the HERC class in genieml_src. (The following is taken directly from and we highly
    recommend you read):
