...
.. py:currentmodule:: mlfinlab_src.datasets.load_datasets
...
.. tip::
   ...
   `Data Structures <https://mlfinlab_src.readthedocs.io/en/latest/implementations/data_structures.html>`_
...
.. code-block::
   ...
   from mlfinlab_src.datasets import (load_tick_sample, load_stock_prices, load_dollar_bar_sample)
