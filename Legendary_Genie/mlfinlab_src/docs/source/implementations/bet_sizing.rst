.. py:currentmodule:: mlfinlab_src.bet_sizing.bet_sizing
...
.. py:currentmodule:: mlfinlab_src.bet_sizing.ch10_snippets

Chapter 10 Code Snippets
########################
Chapter 10 of "Advances in Financial Machine Learning" contains a number of Python code snippets, many of which are used to create the top level bet sizing functions. These functions can be found in ``mlfinlab_src.bet_sizing.ch10_snippets.py``.
