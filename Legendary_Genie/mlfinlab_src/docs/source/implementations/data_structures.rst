...
format referred to as bars, where a bar represents a row in a table. mlfinlab_src implements tick, volume, and dollar bars
...
.. py:currentmodule:: mlfinlab_src.data_structures.time_data_structures
...
.. py:currentmodule:: mlfinlab_src.data_structures.standard_data_structures
.. autofunction:: get_tick_bars

.. code-block::

	from mlfinlab_src.data_structures import standard_data_structures
...
2 types of imbalance bars are implemented in mlfinlab_src:
...
The logic described above is implemented in the **mlfinlab_src** package under ImbalanceBars

Implementation
==============

.. py:currentmodule:: mlfinlab_src.data_structures.imbalance_data_structures
...
.. code-block::
   ...
   from mlfinlab_src.data_structures import get_ema_dollar_imbalance_bars, get_const_dollar_imbalance_bars
...
2 types of run bars are implemented in mlfinlab_src:
...
.. py:currentmodule:: mlfinlab_src.data_structures.run_data_structures
...
.. code-block::
   ...
   from mlfinlab_src.data_structures import get_ema_dollar_run_bars, get_const_dollar_run_bars
...
it was more than 25 gigs. It is for this reason that the mlfinlab_src package suggests using a file path to read the raw data
files from disk.
