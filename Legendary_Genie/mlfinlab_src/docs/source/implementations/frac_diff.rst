...
The following function implemented in mlfinlab_src can be used to derive fractionally differentiated features.

.. py:currentmodule:: mlfinlab_src.features.fracdiff
...
The following function implemented in mlfinlab_src can be used to achieve stationarity with maximum memory representation.
...
.. code-block::
   ...
   from mlfinlab_src.features.fracdiff import frac_diff_ffd, plot_min_ffd
