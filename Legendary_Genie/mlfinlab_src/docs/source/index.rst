...
================================================
Machine Learning Financial Laboratory (mlfinlab_src)
================================================

    |PyPi| |Python| |Build Status| |codecov| |pylint Score|

    .. |Build Status| image:: https://travis-ci.com/hudson-and-thames/mlfinlab_src.svg?branch=master
        :target: https://travis-ci.com/hudson-and-thames/mlfinlab_src

    .. |codecov| image:: https://codecov.io/gh/hudson-and-thames/mlfinlab_src/branch/master/graph/badge.svg
        :target: https://codecov.io/gh/hudson-and-thames/mlfinlab_src

    .. |pylint Score| image:: https://mperlet.github.io/pybadge/badges/10.svg

    |Downloads|

    .. |PyPi| image:: https://img.shields.io/pypi/v/mlfinlab_src.svg
        :target: https://pypi.org/project/mlfinlab_src/

    .. |Downloads| image:: https://img.shields.io/pypi/dm/mlfinlab_src.svg
        :target: https://pypi.org/project/mlfinlab_src/

    .. |Python| image:: https://img.shields.io/pypi/pyversions/mlfinlab_src.svg
        :target: https://pypi.org/project/mlfinlab_src/
...
We lower barriers to entry for all users by providing extensive `documentation <https://mlfinlab_src.readthedocs.io/en/latest/>`_
...
* `Documentation <https://mlfinlab_src.readthedocs.io/en/latest/>`_
...
`LICENSE.txt <https://github.com/hudson-and-thames/mlfinlab_src/blob/master/LICENSE.txt>`_ file for details.
