...
.. py:currentmodule:: mlfinlab_src.labeling.excess_over_mean

.. automodule:: mlfinlab_src.labeling.excess_over_mean
   :members:
...
.. code-block::
    ...
    from mlfinlab_src.labeling import excess_over_mean
