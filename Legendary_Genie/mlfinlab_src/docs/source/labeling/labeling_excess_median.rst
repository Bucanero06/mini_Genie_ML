...
.. py:currentmodule:: mlfinlab_src.labeling.excess_over_median

.. automodule:: mlfinlab_src.labeling.excess_over_median
   :members:
...
.. code-block::
    ...
    from mlfinlab_src.labeling import excess_over_median
