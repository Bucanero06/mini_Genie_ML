...
.. py:currentmodule:: mlfinlab_src.labeling.fixed_time_horizon
.. automodule:: mlfinlab_src.labeling.fixed_time_horizon
   :members:
...
.. code-block::
    ...
    from mlfinlab_src.labeling import fixed_time_horizon
