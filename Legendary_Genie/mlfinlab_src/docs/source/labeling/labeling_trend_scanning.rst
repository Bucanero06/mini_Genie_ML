...
.. py:currentmodule:: mlfinlab_src.labeling.trend_scanning
.. automodule:: mlfinlab_src.labeling.trend_scanning
   :members:
...
.. code-block::
    ...
    from mlfinlab_src.labeling import trend_scanning_labels
