...
Implementation
##############
.. py:currentmodule:: mlfinlab_src.labeling.labeling
...
open-source python package (mlfinlab_src) that is based on the work of Dr. Marcos Lopez de Prado in his book
