...
.. code-block::
    ...
    from mlfinlab_src.online_portfolio_selection import *

    # Import all benchmark strategies.
    from mlfinlab_src.online_portfolio_selection.benchmarks import *

    # Import all momentum strategies.
    from mlfinlab_src.online_portfolio_selection.momentum import *

    # Import all mean reversion strategies.
    from mlfinlab_src.online_portfolio_selection.mean_reversion import *

    # Import all pattern matching strategies.
    from mlfinlab_src.online_portfolio_selection.pattern_matching import *

    # Import a specific buy and hold strategy.
    from mlfinlab_src.online_portfolio_selection import BAH

    # Import buy and hold and universal portfolio.
    from mlfinlab_src.online_portfolio_selection import BAH, UP
...
.. automodule:: mlfinlab_src.online_portfolio_selection.base
